<form action="post_registrate.php" method="POST">
  <div class="container">
    ...
    <label for="name"><b>Name</b></label>
      <?php if (isset($input) && (isset($input->getErrors()['name']))): ?>
    ...
    <label for="psw-repeat"><b>Repeat Password</b></label>
      <?php if (isset($input) && (isset($input->getErrors()['psw-repeat']))): ?>
  ...
  <div class="container signin">
    <p>Already have an account? <a href="/src/actions/get_login.php">Sign in</a>.</p>
  </div>
</form>
<style>
